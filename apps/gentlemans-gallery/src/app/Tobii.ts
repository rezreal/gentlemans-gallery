...
type EyeTrackingDeviceStatus = "Configuring" |
    "ConnectionError" | "DeviceNotConnected" | "Initializing" | "InvalidConfiguration" |
    "NotAvailable" | "Tracking" | "TrackingPaused" | "TrackingUnavailable" | "UnknownError";
...
type ProtocolFrame = GazePointDataFrame | EyePositionDataFrame | HeadPoseDataFrame | TobiiStateFrame;
